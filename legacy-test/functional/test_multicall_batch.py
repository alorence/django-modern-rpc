...
class TestMultiCall:
    ...
    def test_xmlrpc_multicall_with_unknown_method(self, xmlrpc_client):
        result = xmlrpc_client.multicall(
            [
                ("add", [5, 10]),
                ("unknown_method", []),
    ...
    def test_xmlrpc_multicall_with_zero_division_error(self, xmlrpc_client):
        result = xmlrpc_client.multicall(
            [
                ("add", [5, 10]),
                ("divide", [30, 0]),
...
@pytest.mark.skip(reason="to be replaced by unit tests")
class TestBatch:
    def test_jsonrpc_multicall_error(self, jsonrpc_client):
    ...
    def test_jsonrpc_batch(self, jsonrpc_client):
    ...
    def test_jsonrpc_batch_with_unknown_method(self, jsonrpc_client):
        result = jsonrpc_client.batch_request(
            [
                ("add", [5, 10]),
                ("unknown_method", []),
    ...
    def test_jsonrpc_batch_with_zero_division_error(self, jsonrpc_client):
        result = jsonrpc_client.batch_request(
            [
                ("add", [5, 10]),
                ("divide", [9, 0]),
    ...
    def test_jsonrpc_batch_with_named_params(self, jsonrpc_client):
        result = jsonrpc_client.batch_request(
            [
                ("add", {"a": 5, "b": 10}),
    ...
    def test_jsonrpc_batch_with_notify(self, jsonrpc_client):
        result = jsonrpc_client.batch_request(
            [
                ("add", {"a": 5, "b": 10}),
    ...
    def test_jsonrpc_batch_with_only_notify(self, jsonrpc_client):
        result = jsonrpc_client.batch_request(
            [
    ...
    def test_jsonrpc_batch_invalid_payload_1(self, live_server, endpoint_path):
    ...
    def test_jsonrpc_batch_invalid_payload_2(self, live_server, endpoint_path):
        invalid_payload = [
