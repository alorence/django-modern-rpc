...
from modernrpc.auth import (
    user_is_anonymous, user_is_authenticated, user_is_superuser,
    user_has_perm, user_has_all_perms, user_has_any_perm,
    user_in_group, user_in_all_groups, user_in_any_group,
)
...
class TestAuthentication:
    ...
    def test_http_basic_get_user(self, ):
