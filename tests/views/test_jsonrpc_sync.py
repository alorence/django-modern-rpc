...
class TestJsonRpcSyncView:
    def test_standard_call(self, jsonrpc_rf, server, asynchronous):
    ...
    def test_notification_call(self, jsonrpc_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_procedure_exception(self, jsonrpc_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_notification_exception(self, jsonrpc_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_invalid_json_payload_request(self, jsonrpc_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_invalid_params(self, jsonrpc_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_invalid_result(self, jsonrpc_rf, server, asynchronous):
    ...
    def test_system_list_methods(self, jsonrpc_rf, server, asynchronous):
    ...
    def test_system_method_signature(self, jsonrpc_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_system_method_help(self, jsonrpc_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_system_method_signature_invalid_arg(self, jsonrpc_rf, server, asynchronous):
    ...
    def test_system_method_help_invalid_arg(self, jsonrpc_rf, server, asynchronous):
    ...
    def test_system_multicall_unavailable(self, jsonrpc_rf, server, asynchronous):
...
class TestJsonRpcSyncBatch:
    def test_jsonrpc_batch_basics(self, jsonrpc_batch_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    def test_jsonrpc_batch_all_notif(self, jsonrpc_batch_rf, server, asynchronous):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
        request = jsonrpc_batch_rf(
