...
class TestXmlRpcAsyncView:
    async def test_standard_call(self, xmlrpc_rf, server, asynchronous, on_error_mock):
    ...
    async def test_procedure_exception(self, xmlrpc_rf, server, asynchronous, on_error_mock):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    async def test_invalid_xml_payload_request(self, xmlrpc_rf, server, asynchronous, on_error_mock):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    async def test_invalid_params(self, xmlrpc_rf, server, asynchronous, on_error_mock):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    async def test_invalid_result(self, xmlrpc_rf, server, asynchronous, on_error_mock):
    ...
    async def test_system_list_methods(self, xmlrpc_rf, server, asynchronous, on_error_mock):
    ...
    async def test_system_method_signature(self, xmlrpc_rf, server, asynchronous, on_error_mock):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    async def test_system_method_help(self, xmlrpc_rf, server, asynchronous, on_error_mock):
        method_name = "async_simple_procedure" if asynchronous else "simple_procedure"
    ...
    async def test_system_method_signature_invalid_arg(self, xmlrpc_rf, server, asynchronous, on_error_mock):
    ...
    async def test_system_method_help_invalid_arg(self, xmlrpc_rf, server, asynchronous, on_error_mock):
...
class TestXmlRpcAsyncMulticall:
    async def test_multicall_standard(self, xmlrpc_rf, server, on_error_mock):
        mc_params = [
            [
    ...
    async def test_multicall_invalid_params_1(self, xmlrpc_rf, server, on_error_mock):
        mc_params = ["foo.bar"]
        request = xmlrpc_rf(method_name="system.multicall", params=mc_params)
    ...
    async def test_multicall_invalid_params_2(self, xmlrpc_rf, server, on_error_mock):
        mc_params = [
            {
                "calls": [
                    {"methodName": "simple_procedure", "params": ("xxx", 20)},
