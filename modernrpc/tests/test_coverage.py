...
from modernrpc.tests.test_rpc_method_class import dummy_function_with_doc
...
from .test_rpc_method_class import dummy_function, single_line_documented, multi_line_documented_1, \
