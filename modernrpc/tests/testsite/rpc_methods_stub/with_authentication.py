from modernrpc.auth import login_required, superuser_required, permissions_required, group_member_required
...
@group_member_required(groups='A')
@rpc_method
def in_group_A_required(x):
    return x


@group_member_required(groups=['A', 'B'])
@rpc_method
